...
namespace Open.Tests.Aids
{
    ...
    public class GetRandomTests : BaseTests
    {
        ...
        public void FloatTest()
        {
            ...
            doGetRandomTest(GetRandom.Float, -50F, 50F);
        ...
        public void UInt8Test()
        {
            ...
            doGetRandomTest(GetRandom.UInt8, byte.MinValue, (byte)(byte.MinValue + 200));
        ...
        {
            doGetRandomTest(GetRandom.UInt16, (ushort)10, (ushort)110);
