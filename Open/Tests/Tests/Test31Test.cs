...
public class Test31Test {
  ...
  [Test]
  public void test31() {
    driver.Navigate().GoToUrl("https://pharmastock.azurewebsites.net/Persons/Create");
    ...
    driver.FindElement(By.Id("IDCode")).SendKeys("49702101000");
    driver.FindElement(By.Id("IDCode")).Click();
    driver.FindElement(By.Id("IDCode")).SendKeys("59702101000");
