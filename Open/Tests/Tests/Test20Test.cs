...
public class Test20Test {
  ...
  public void test20() {
    ...
    driver.FindElement(By.Id("IDCode")).Click();
    {
      var element = driver.FindElement(By.Id("IDCode"));
      Actions builder = new Actions(driver);
      builder.DoubleClick(element).Perform();
    }
    driver.FindElement(By.Id("IDCode")).SendKeys("49702a0121%");
    ...
    driver.FindElement(By.Id("PhoneNumber")).SendKeys("55536861");
    ...
    driver.FindElement(By.Id("ValidFrom")).Click();
    {
      var element = driver.FindElement(By.Id("ValidFrom"));
      Actions builder = new Actions(driver);
      builder.DoubleClick(element).Perform();
    }
    driver.FindElement(By.Id("ValidFrom")).Click();
